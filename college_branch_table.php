...
FROM student
WHERE s_branch='$branch_name' AND c_code='$login_session' AND s_year='$year' AND usn IN


(select usn
from fees_paid fp 
where fp.b_id='$branch_name' and fp.c_id='$login_session' and fp.y_id='$year' and fp.f_id='$fees')";
    ...
    <div class="col-md-6">
      ...
      <table class="table table-striped table-dark table-hover">
        ...
        <?php
            ...
            $sql = "SELECT usn,s_name
FROM student
WHERE s_branch='$branch_name' AND c_code='$login_session' AND s_year='$year' AND usn NOT IN
